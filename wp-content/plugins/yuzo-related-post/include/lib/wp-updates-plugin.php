...
new WPUpdatesPluginUpdater_2120( 'http://wp-updates.com/api/2/plugin', plugin_basename(__FILE__) );
*/

if( !class_exists('WPUpdatesPluginUpdater_2120') ) {
    class WPUpdatesPluginUpdater_2120 {
    	...
    	function check_for_update( $transient ) {
    		...
    		if( empty( $transient->checked[$this->plugin_path] ) ) return $transient;
    		$request_args = array(
    		    'id' => $this->plugin_id,
