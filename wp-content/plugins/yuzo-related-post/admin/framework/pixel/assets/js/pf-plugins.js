(function() {
  var $ = jQuery;
  function PFAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  PFAjaxChosen.prototype.init = function() {
  ...
  PFAjaxChosen.prototype.events = function() {
  ...
  PFAjaxChosen.prototype.search_field_focused = function() {
  ...
  PFAjaxChosen.prototype.search_welcome_message = function() {
  ...
  PFAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('pf-chosen', _this.options.data).done( function( response ) {
  ...
  PFAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.pf-hidden-select');
  ...
  jQuery.fn.PFAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new PFAjaxChosen(this, chosenOptions);
    });
  };
