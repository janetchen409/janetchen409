 ...
 *
 * @since   1.5   2019-07-14 13:19:44   Release
 */
if( ! class_exists( 'WP_Customize_Panel_PF' ) && class_exists( 'WP_Customize_Panel' ) ) {
  class WP_Customize_Panel_PF extends WP_Customize_Panel {
    public $type = 'pf';
  }
}
 ...
 * @since   1.5   2019-07-14 13:19:44   Release
 */
if( ! class_exists( 'WP_Customize_Section_PF' ) && class_exists( 'WP_Customize_Section' ) ) {
  class WP_Customize_Section_PF extends WP_Customize_Section {
    public $type = 'pf';
  }
}
 ...
 * @since   1.5   2019-07-14 13:19:44   Release
 */
if( ! class_exists( 'WP_Customize_Control_PF' ) && class_exists( 'WP_Customize_Control' ) ) {
  class WP_Customize_Control_PF extends WP_Customize_Control {
    ...
    protected function render() {
      ...
      if ( ! empty( $this->field['dependency'] ) ) {
        $hidden  = ' pf-dependency-control hidden';
    ...
    public function render_content() {
      ...
      $class      = ( $is_complex || $custom ) ? ' pf-customize-complex' : '';
      ...
      echo '<div class="pf-customize-field'. $class .'"'. $atts .'>';

      PF::field( $this->field, $this->value(), $this->unique, 'customize' );
