    ...
    public function render() {
        ...
        if( isset( $this->field['options'] ) ) {
            ...
            if( ! empty( $args['ajax'] ) ) {
                ...
                $args['settings']['data']['nonce'] = wp_create_nonce( 'pf_chosen_ajax_nonce' );
            ...
            $chosen_sortable  = ( $args['chosen'] && $args['sortable'] ) ? ' pf-chosen-sortable' : '';
            $chosen_ajax      = ( $args['chosen'] && $args['ajax'] ) ? ' pf-chosen-ajax' : '';
            $placeholder_attr = ( $args['chosen'] && $args['placeholder'] ) ? ' data-placeholder="'. $args['placeholder'] .'"' : '';
            $field_class      = ( $args['chosen'] ) ? ' class="pf-chosen'. $chosen_rtl . $chosen_sortable . $chosen_ajax .'"' : '';
            ...
            if( is_array( $options ) && ! empty( $options ) || ! empty( $args['chosen'] ) ) {
                ...
                if( ! empty( $args['chosen'] ) && ! empty( $args['multiple'] ) ) {
                    ...
                    echo '<select name="'. $field_name .'" class="pf-hidden-select pf-hidden"'. $multiple_attr . $field_attr .'>';
