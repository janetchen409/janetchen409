...
class DFlip_Settings {
  ...
  public function settings_page() {
    ...
    <h2><?php echo esc_html( get_admin_page_title() ); ?> <a href="https://1.envato.market/c/1287877/275988/4415?subId1=wp-lite&subId2=plugin-admin&subId3=settings&u=https://codecanyon.net/item/dflip-flipbook-wordpress-plugin/16408847" target="_blank">Buy Full Version</a></h2>
  ...
  public function updated_settings() {
      ...
      <div class="error">
        <p><?php _e( 'Settings can be saved only in Premium Version updated.', 'DFLIP' ); ?> <a
                  href="https://1.envato.market/c/1287877/275988/4415?subId1=wp-lite&subId2=plugin-admin&subId3=settings-error&u=https://codecanyon.net/item/dflip-flipbook-wordpress-plugin/16408847" target="_blank">Buy Full Version</a></p>
      </div>
      <?php
  }
