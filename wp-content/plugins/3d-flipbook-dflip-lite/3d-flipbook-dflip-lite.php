 ...
 * Description: Realistic 3D Flipbooks for Wordpress <a
 * href="https://1.envato.market/c/1287877/275988/4415?subId1=wp-lite&subId2=plugin-admin&subId3=plugin-list&u=https://codecanyon.net/item/dflip-flipbook-wordpress-plugin/16408847" >Get Full Version
 * Here</a><strong>NOTE : Deactivate this lite version before activating Full Version</strong>
 *
 * Version: 1.5.8
 *
 * Text Domain: DFLIP
 * Author: DearHive
 * Author URI: https://1.envato.market/c/1287877/275988/4415?subId1=wp-lite&subId2=plugin-admin&subId3=author-link&u=http://codecanyon.net/user/dearhive
 *
 */
...
if ( !class_exists( 'DFlip' ) ) {
  ...
  class DFlip {
    ...
    public function __construct() {
      ...
      add_action( 'plugins_loaded', array( $this, 'dflip_lite_check' ) );
    }
