...
function roseta_master_footer() {
	...
	echo '<div style="display:block;float:right;clear: right;">' . __( "", "" ) .
		'<a target="_blank" href="' . esc_html( $the_theme->get( 'ThemeURI' ) ) . '" title="';
	echo 'Roseta WordPress Theme by ' . 'Cryout Creations"> ' . '' .'</a>  <a target="_blank" href="' . "";
	echo '" title="' . esc_attr__( "Semantic Personal Publishing Platform", "") . '"> ' . sprintf( " ", "" ) . '</a></div>';
}
